        ...
        {results.length > 1 ? (
          ...
          <div className='results__wrapper'>
            <div>
              <p>I think...</p>
              <p>
                You look {results[0].expressions.asSortedArray()[0].expression}
              </p>
            ...
            <div className='results__emoji'>
              ...
              />
              <FontAwesomeIcon
                icon={mapExpressionToEmoji(results[0].gender)}
                size='4x'
              />
            </div>
          </div>
    ...
    return (
      <div className='results'>
        <p className='f3 b black'>
          If it takes more than 5 minutes take another picture
        </p>
        <Spinner />
      </div>
    );
